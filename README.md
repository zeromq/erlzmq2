...
In order to build erlzmq2 against a specific version of ZeroMQ (not `v2.1.10`), use this:
...
If you want to build against a specific version of ZeroMQ (not `v2.1.10`), use this:
